...
/// <summary>
/// MySQL-specific implementation of the event store.
/// </summary>
public sealed class MySqlEventStore<TStore> : BaseEventStore<TStore> where TStore: MySqlEventStoreOptions
{
    ...
    public MySqlEventStore(
        ...
        ILogger<MySqlEventStore<TStore>> logger,
