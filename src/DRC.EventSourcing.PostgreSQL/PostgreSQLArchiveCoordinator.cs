...
/// <summary>
/// Coordinates archiving events from the PostgreSQL hot store into
/// NDJSON files on disk and marking their ranges as archive segments.
/// </summary>
public sealed class PostgreSQLArchiveCoordinator<TStore> : BaseArchiveCoordinator<TStore>
    where TStore : PostgreSQLEventStoreOptions
{
    private readonly TStore _options;
    private readonly JsonSerializerOptions _jsonOptions;

    public PostgreSQLArchiveCoordinator(
